...
const VALID_WORDS_ES = {
  prenom:{
    A:["aaron","abigail","abraham","adela","adriana","agustin","alba","alberto","alejandro","alex","alfredo","alicia","alonso","alvaro","amalia","amelia","ana","andres","angela","antonio","arturo","agata","aide","aileen","ainara","ainhoa","alan","alana","aldana","aldrich","alejandra"],
    ...
    R:["rafael","ramona","raul","rebeca","ricardo","roberto","rodrigo","rosa","ruben","ramiro","renata","reynaldo","rocio","rolando","roque","rosario"],
  ...
  ville:{
    ...
    I:["islamabad"],
    J:["jakarta","jerusalen","johannesburgo"],
    K:["kabul","kampala","karachi","katmandu","kigali","kinshasa","kingston","kuala lumpur","kiev"],
    L:["la habana","lagos","lima","lisboa","londre","los angeles","la paz","lahore","libreville","lome","luanda","lusaka"],
    M:["madrid","manila","marsella","medellin","milan","minsk","mogadiscio","monrovia","montevideo","montreal","moscu","mumbai","munich"],
    N:["nairobi","nassau","niamey","nueva york","nueva delhi","nueva orleans"],
    O:["osaka","oslo"],
    P:["paris","pekin","phnom penh","praga","pretoria","panama","palermo","perth"],
    Q:["quezon city","quito"],
  ...
  animal:{
    ...
    C:["caiman","camaleón","camello","canguro","capibara","caracol","carpa","castor","cebra","ciervo","cobra","cocodrilo","conejo","corazon","coyote","cucaracha","cuervo"],
    D:["delfin","dinosaurio"],
  ...
  technologie:{
    ...
    A:["algoritmo","android","antivirus","api","aplicacion","automatizacion"],
    B:["banda ancha","binario","bitcoin","blockchain","bluetooth","bug"],
    C:["chatbot","chip","codigo","compilador","cpu","ciberseguridad"],
    D:["datos","debug","digital","drone"],
  ...
  personnage:{
    ...
    W:["wolverine"],},
  capital:{
    A:["abu dabi","abuja","accra","addis abeba","alger","amman","andorra la vella","ankara","antananarivo","apia","asmara","asuncion","astana","atenas"],
    B:["bagdad","bamako","bangui","banjul","beijing","belgrado","belmopan","berlin","berna","biskek","bissau","bogota","brasilia","bratislava","brazzaville","bridgetown","bruselas","bujumbura","budapest"],
    C:["cairo","camberra","caracas","castries","chisinau","colombo","conakry","copenhague","ciudad de guatemala"],
    D:["dakar","daca","dili","dodoma","doha"],
    E:["edimburgo","erevan"],
    F:["freetown","funafuti"],
    G:["gaborone","georgetown"],
    H:["harare","helsinki","honiara"],
    I:["islamabad"],
    J:["jakarta","jamestown","jerusalen"],
    K:["kabul","kampala","katmandu","kigali","kingston","kinshasa","kuala lumpur","kiev"],
    L:["la paz","libreville","lilongwe","lima","lisboa","lome","luanda","lusaka"],
    M:["madrid","male","managua","manila","maputo","maseru","mbabane","minsk","mogadiscio","monrovia","montevideo","moroni","moscu","muscat"],
    N:["nairobi","nassau","naypyidaw","niamey","nicosia","nueva delhi","nukualofa"],
    O:["oslo","ottawa","ouagadougou"],
    P:["palikir","panama","paris","phnom penh","port au prince","porto novo","praga","pretoria"],
    R:["rabat","reykjavik","riga","riad","roma"],
    S:["san jose","santiago","santo domingo","sarajevo","seul","singapur","skopje","sofia","suva"],
    T:["taipei","tashkent","tbilisi","tegucigalpa","teheran","thimphu","tirana","tokio","tripoli","tunez","tallin"],
    V:["vaduz","valleta","viena","vilna"],},
  cuisine:{
    A:["adobo","aguacate","albondigas","alcachofas","almejas","arroz","asado","atole"],
    B:["bacalao","barbacoa","boquerones","buñuelos","burrito"],
    C:["caldo","carne asada","carnitas","ceviche","chicharron","chorizo","cocido","cochinita","croquetas"],
    D:["dulce de leche","dorada"],
    E:["empanada","enchilada","ensalada","escabeche","espagueti"],
    F:["fajita","flan","frijoles","fritura"],
    G:["gazpacho","guacamole","garbanzos","guisado"],
    H:["hamburguesa","hotdog","hummus"],
    I:["idli","injera"],
    J:["jamon","jambalaya"],
    K:["kebab","kimchi"],
    L:["lasagna","langosta","lentejas","lomo saltado"],
    M:["mole","morcilla","moussaka","migas","mariscos"],
    N:["nachos","naan","natillas","nems"],
    O:["olla podrida","ostras","osso buco","olivas"],
    P:["paella","pasta","pizza","polenta","pozole","pulpo"],
    R:["ramen","risotto","ropa vieja"],
    S:["sushi","sopa","steak","salsa","sancocho","sofrito"],
    T:["tacos","tamales","tempura","tiramisu","tortilla"],
    V:["verduras","vichyssoise","vieiras"],},
  instrument:{
    A:["acordeon","arpa","alphorn","angklung"],
    B:["bandurria","banjo","bajo","berimbau","bongo"],
    C:["castañuelas","cello","clarinete","clavicordio","conga","charango"],
    D:["didgeridoo","djembe","dulcimer"],
    E:["eufonio"],
    F:["flauta","fagot"],
    G:["guitarra","gong","gaita","gamelan"],
    H:["harmonica","harmonium","helicon"],
    I:["instrumento de cuerda"],
    J:["jews harp"],
    K:["kalimba","kazoo","koto"],
    L:["laud","lira"],
    M:["mandolina","maracas","marimba","melodica"],
    N:["nyckelharpa","ngoni","nay"],
    O:["oboe","organo"],
    P:["piano","piccolo","percusiones"],
    R:["rebab","recorder"],
    S:["saxofon","sitar","sintetizador","steel drum"],
    T:["trompeta","tuba","tambor","theremin","triangulo","trombon"],
    V:["violin","violonchelo","viola"],},
  langue:{
    A:["afrikaans","albanes","aleman","amharico","arabe","armenio","azerbaiyano"],
    B:["bascuence","bielorruso","bengali","birmano","bosnio","bulgaro","breton"],
    C:["cantones","catalan","checo","chino","coreano","croata"],
    D:["danes","dari"],
    E:["español","eslovaco","esloveno","estonio","esperanto"],
    F:["farsi","filipino","finlandes","frances"],
    G:["gales","gallego","georgiano","griego","guarani"],
    H:["hausa","hebreo","hindi","hungaro"],
    I:["ingles","islandes","indonesio","italiano","igbo"],
    J:["japones","javanes"],
    K:["kazajo","kirguis","kannada","kinyarwanda","kurdo"],
    L:["leton","latin","lituano","luganda"],
    M:["macedonio","malagasy","malayo","maltes","mandarin","marathi","mongol"],
    N:["nepales","noruego","neerlandes"],
    O:["ourdou","oriya"],
    P:["pashto","persa","polaco","portugues","punjabi"],
    R:["rumano","ruso"],
    S:["serbio","somali","swahili","sueco","sindhi"],
    T:["tamil","telugu","tailandes","tibetano","turco"],
    V:["vietnamita","valenciano"],},
  monument:{
    A:["acropolis","alhambra","angkor wat","arco de triunfo"],
    B:["big ben","borobudur","burj khalifa"],
    C:["chichen itza","cristo redentor","coliseo"],
    E:["estatua de la libertad"],
    F:["foro romano","fontana de trevi"],
    G:["gran muralla china","gran canon","gran piramide"],
    H:["hagia sofia","hradcany"],
    I:["invalides"],
    J:["jungfrau"],
    K:["kaaba","kremlin","karnak"],
    L:["louvre","leaning tower","leptis magna"],
    M:["machu picchu","monte saint michel"],
    N:["notre dame","nazca"],
    O:["opera de sydney"],
    P:["partenon","petra","piramides de giza"],
    R:["reichstag"],
    S:["sagrada familia","stonehenge","senado romano","sigiriya"],
    T:["taj mahal","templo"],
    V:["vaticano","versalles"],},
  vehicule:{
    A:["avion","autobus","automovil","ambulancia","autocar"],
    B:["barco","bicicleta","bus","bulldozer"],
    C:["camion","canoa","caravana","catamaran","camioneta"],
    D:["deltaplane","dirigible","dron"],
    E:["excavadora","embarcacion"],
    F:["ferry","furgoneta"],
    G:["gondola"],
    H:["helicoptero","hovercraft","hidroavion"],
    I:["isetta"],
    J:["jeep","jet","jet ski"],
    K:["kayak","karting"],
    L:["limusina","locomotora","lancha"],
    M:["moto","metro","monorail","minibus","motocicleta"],
    N:["nave","navette"],
    O:["omnibus"],
    P:["planeador","piragua","patinete","pick up"],
    R:["remolque","roadster"],
    S:["scooter","submarino","segway","suv"],
    T:["tren","tractor","tranvia","taxi","tanque"],
    V:["velero","vespa","van","volkswagen"],},
  vetement:{
    A:["abaya","abrigo","anorak"],
    B:["bikini","blazer","blusa","botas","bra"],
    C:["camisa","capa","cardigan","cinturon","corbata","camiseta"],
    D:["disfraz","dashiki"],
    E:["escarpin"],
    F:["fular","frac"],
    G:["guantes","gorra"],
    ...
    K:["kaftan","kilt","kimono"],
    L:["leggins","lenceria"],
    M:["minifalda","mitones","maillot","mocasines"],
    N:["niqab"],
    O:["overall","overcoat"],
    P:["pantalon","parka","polo","poncho","pijama"],
    R:["ropa","raincoat"],
    S:["sari","sarong","shorts","slip","sombrero","sueter"],
    T:["traje","trench","tunica","tuxedo","turbante"],
    V:["vestido","velo"],},};
